...
export const en: Messages = {
  ...
  reviews: {
    ...
    contentOptional: 'Review text (optional)',
    saving: 'Saving…',
    editButton: 'Update',
  ...
  auth: {
    ...
    consentMarketing: 'Marketing emails and newsletter',
    consentView: 'View',
    consentRequiredError: 'Please agree to all required terms.',
    completeProfileTitle: 'Complete sign-up',
    completeProfileDescription:
      'Choose a nickname for reviews and community activity, and agree to the required terms.',
    completeProfileSaving: 'Saving…',
    completeProfileSubmit: 'Get started',
